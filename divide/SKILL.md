...
- Pairs with `ponytail` (cuts code scope) — this cuts *project* scope. And with `brainstorm` when the idea genuinely needs design first; but if the problem is overwhelm, start here, not there.
